...
<body> 
	...
	<!-- Top box -->
		...
		<div class="placeholder">
			<div class="parallax-window" data-parallax="scroll" data-image-src="img/Home-03.jpg">
				<div class="tm-header">
					<div class="row tm-header-inner">
						<div class="col-md-6 col-12">
							<img src="img/logo-01.png"Logo" class="tm-site-logo" /> 
							<div class="tm-site-text-box">
								<h1 class="tm-site-title">App Guru</h1>
								<h6 class="tm-site-description">Mod Your Day!!!</h6>	
							</div>
						</div>
		...
		<main>
			<header class="row tm-welcome-section">
				<h2 class="col-12 text-center tm-section-title">Welcome to App Guru</h2>
				<p class="col-12 text-center">Find Best Alternative Some More funclunal App of Your Regular App</p>
			</header>
				...
				<div id="tm-gallery-page-pizza" class="tm-gallery-page">
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							...
							<figcaption>
								<h4 class="tm-gallery-title">Instagram</h4>
								<p class="tm-gallery-description">Socia Media App</p>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="img/gallery/02.png" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
								<h4 class="tm-gallery-title">WhatsApp</h4>
								<p class="tm-gallery-description">Social Media App</p>
				...
				<div class="row">
					<div class="col-md-6">
						<figure class="tm-description-figure">
							<img src="img/Home-02.jpg" alt="Image" class="img-fluid" />
						</figure>
					</div>
					<div class="col-md-6">
		...
		<footer class="tm-footer text-center">
            ...
            | Design: <a rel="nofollow" href="#">Udstar & Team</a></p>
		</footer>
	</div>
